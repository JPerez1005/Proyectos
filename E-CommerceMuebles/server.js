...
const firebaseConfig = {
  apiKey: "AIzaSyCbD0vnb4u7GllmVeFLwEZL_k8Sow8xPGc",
  authDomain: "ecom-website-furniture.firebaseapp.com",
  projectId: "ecom-website-furniture",
  storageBucket: "ecom-website-furniture.appspot.com",
  messagingSenderId: "355413450581",
  appId: "1:355413450581:web:a7d85098beebd0c2c559dc"
};
        ...
        getDoc(doc(users, email)).then(user => {
            if(user.exists()){
                ...
                bcrypt.genSalt(10, (err, salt)=>{
                    if (err) {
                        return res.json({'alert' : 'Error encrypting password'});
                    }
...
app.post('/seller', (req, res) =>{
    ...
    if (!name.length || !address.length || !about.length || number.length < 10 || isNaN(number)) {
        return res.json({ 'alert' : 'Some information is incorrect.'});
    } else{
